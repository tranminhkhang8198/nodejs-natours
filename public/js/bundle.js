...
function () {
  ...
  regeneratorRuntime.mark(function _callee(email, password) {
    var res, JWT_COOKIE_EXPIRES_IN, jwt;
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              JWT_COOKIE_EXPIRES_IN = new Date(Date.now() + 90 * 24 * 60 * 60 * 1000);
              jwt = res.data.token;
              document.cookie = "jwt=".concat(jwt, ";expires=").concat(JWT_COOKIE_EXPIRES_IN, ";path=/");
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status == 'success') {
              // MY OWN CODE
              JWT_COOKIE_EXPIRES_IN = new Date(Date.now() + 10 * 1000);
              document.cookie = "jwt=loggedOut;expires=".concat(JWT_COOKIE_EXPIRES_IN, ";path=/");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              console.log(res); // document.getElementById('name').value = res.data.data.u
            }
